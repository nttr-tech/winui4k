...
import jp.hisano.winui4k.internal.winrt.Pinterface
...
internal object Abi {
    ...
    const val IToggleButton_get_IsChecked = 6          // get_IsChecked(out IReference<boolean>) — nullable
    ...
    const val IRatingControl_get_Value = 20            // get_Value(out DOUBLE) — -1 when unset
    ...
    /**
     * Runtime-computed actual IID of TypedEventHandler<RatingControl, Object>.
    ...
    /**
     * Runtime-computed actual IID of TypedEventHandler<TeachingTip, Object>.
     * Both ActionButtonClick and CloseButtonClick use this type (TArgs is Object).
     */
    ...
    // ---- Microsoft.UI.Xaml.Controls.MenuFlyoutItemBase (common base of menu items) ----
    ...
    // ---- Microsoft.UI.Xaml.Controls.AppBar (CommandBar's base) ----
    ...
    // ---- Microsoft.UI.Xaml.Controls.SymbolIconSource (IconSource-derived) ----
    ...
    const val IID_ITitleBarFactory = "c4452799-4606-59ef-9392-a0548d48b82e"
    const val IID_ITitleBar = "c552714d-5d30-5a2b-9c7a-d68bea3dde8d"
    const val ITitleBar_get_Title = 6
    const val ITitleBar_put_Title = 7
    const val ITitleBar_get_Subtitle = 8
    const val ITitleBar_put_Subtitle = 9
    const val ITitleBar_get_IconSource = 10             // get_IconSource(out IconSource)
    const val ITitleBar_put_IconSource = 11             // put_IconSource(IconSource)
    const val ITitleBar_get_LeftHeader = 12             // get_LeftHeader(out UIElement)
    const val ITitleBar_put_LeftHeader = 13
    const val ITitleBar_get_Content = 14                // get_Content(out UIElement)
    const val ITitleBar_put_Content = 15
    const val ITitleBar_get_RightHeader = 16            // get_RightHeader(out UIElement)
    const val ITitleBar_put_RightHeader = 17
    const val ITitleBar_get_IsBackButtonVisible = 18
    const val ITitleBar_put_IsBackButtonVisible = 19
    const val ITitleBar_get_IsBackButtonEnabled = 20
    const val ITitleBar_put_IsBackButtonEnabled = 21
    const val ITitleBar_get_IsPaneToggleButtonVisible = 22
    const val ITitleBar_put_IsPaneToggleButtonVisible = 23
    const val ITitleBar_add_BackRequested = 25          // add_BackRequested(TypedEventHandler<TitleBar, Object>, out token)
    const val ITitleBar_remove_BackRequested = 26
    const val ITitleBar_add_PaneToggleRequested = 27    // add_PaneToggleRequested(TypedEventHandler<TitleBar, Object>, out token)
    const val ITitleBar_remove_PaneToggleRequested = 28

    const val IID_ITitleBarStatics2 = "cd36d484-36f5-510c-9ecd-7e289c97f263"
    const val ITitleBarStatics2_SetIsDragRegion = 9     // SetIsDragRegion(UIElement, IReference<boolean>)

    // ---- Microsoft.UI.Xaml.Controls.ImageIconSource (derives from IconSource) ----
    const val CLS_ImageIconSource = "Microsoft.UI.Xaml.Controls.ImageIconSource"
    const val IID_IImageIconSourceFactory = "24f76321-71bd-530a-8cc8-3f615cd1437a"
    const val IID_IImageIconSource = "67f75be0-c84d-57ff-9f68-039c81ea7896"
    const val IImageIconSource_put_ImageSource = 7      // put_ImageSource(ImageSource)

    // ---- Microsoft.UI.Xaml.Media.Imaging.BitmapImage (derives from ImageSource) ----
    const val CLS_BitmapImage = "Microsoft.UI.Xaml.Media.Imaging.BitmapImage"
