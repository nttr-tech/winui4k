...
class WPipsPager : WControl(
    ...
    var numberOfPages: Int
        get() = inspectable.getInt(XamlInterop.IPipsPager_get_NumberOfPages)
        set(value) = inspectable.call(XamlInterop.IPipsPager_put_NumberOfPages, value)

    /** The currently selected page (PipsPager.SelectedPageIndex, 0-based). */
    var selectedPageIndex: Int
        get() = inspectable.getInt(XamlInterop.IPipsPager_get_SelectedPageIndex)
        set(value) = inspectable.call(XamlInterop.IPipsPager_put_SelectedPageIndex, value)

    /** The maximum number of dots shown at once (PipsPager.MaxVisiblePips). Excess pips scroll into view. */
    var maxVisiblePips: Int
        get() = inspectable.getInt(XamlInterop.IPipsPager_get_MaxVisiblePips)
        set(value) = inspectable.call(XamlInterop.IPipsPager_put_MaxVisiblePips, value)

    /** The direction the dots are laid out (PipsPager.Orientation, default HORIZONTAL). */
    var orientation: Orientation
        get() = Orientation.of(inspectable.getInt(XamlInterop.IPipsPager_get_Orientation))
        set(value) = inspectable.call(XamlInterop.IPipsPager_put_Orientation, value.native)
    ...
    var previousButtonVisibility: PipsPagerButtonVisibility
        get() = PipsPagerButtonVisibility.of(inspectable.getInt(XamlInterop.IPipsPager_get_PreviousButtonVisibility))
        set(value) = inspectable.call(XamlInterop.IPipsPager_put_PreviousButtonVisibility, value.native)
    ...
    var nextButtonVisibility: PipsPagerButtonVisibility
        get() = PipsPagerButtonVisibility.of(inspectable.getInt(XamlInterop.IPipsPager_get_NextButtonVisibility))
        set(value) = inspectable.call(XamlInterop.IPipsPager_put_NextButtonVisibility, value.native)
    ...
    fun addSelectedIndexChangedListener(listener: (Int) -> Unit) {
        val token = inspectable.addEventHandler(
            ...
            XamlInterop.IPipsPager_add_SelectedIndexChanged,
        ) { _, _ ->
