...
class WVariableSizedWrapGrid(
    ...
    var itemWidth: Double = Double.NaN
        set(value) {
            field = value
            inspectable.call(Abi.IVariableSizedWrapGrid_put_ItemWidth, value)
        }
    ...
    var itemHeight: Double = Double.NaN
        set(value) {
            field = value
            inspectable.call(Abi.IVariableSizedWrapGrid_put_ItemHeight, value)
        }

    /** The direction children are laid out in (VariableSizedWrapGrid.Orientation). Defaults to vertical. */
    var orientation: Orientation
        get() = Orientation.of(inspectable.getInt(Abi.IVariableSizedWrapGrid_get_Orientation))
        set(value) = inspectable.call(Abi.IVariableSizedWrapGrid_put_Orientation, value.native)
    ...
    var maximumRowsOrColumns: Int
        get() = inspectable.getInt(Abi.IVariableSizedWrapGrid_get_MaximumRowsOrColumns)
        set(value) = inspectable.call(Abi.IVariableSizedWrapGrid_put_MaximumRowsOrColumns, value)
    ...
    fun add(component: WComponent, rowSpan: Int, columnSpan: Int) {
        statics.call(Abi.IVariableSizedWrapGridStatics_SetRowSpan, component.uiElement.ptr, rowSpan)
        statics.call(Abi.IVariableSizedWrapGridStatics_SetColumnSpan, component.uiElement.ptr, columnSpan)
        add(component)
    }
