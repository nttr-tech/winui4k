...
internal val pageDescriptions: Map<String, String> = mapOf(
    ...
    "BreadcrumbBar" to "A breadcrumb trail that shows your current position in a hierarchy and lets you jump back up it.",
    ...
    "ProgressBar" to "Shows a task's progress as a bar (indeterminate display supported too).",
    "ProgressRing" to "Shows an ongoing operation or progress as a circular ring.",
    ...
    "SelectorBar" to "A control for switching between a small number of options.",
